#undef PROCEDURAL2DMAPGENERATOR_API
...
#define UE_PROJECT_NAME UnrealTestProject
#define UE_TARGET_NAME UnrealTestProjectEditor
...
#define PROCEDURAL2DMAPGENERATOR_API DLLEXPORT
